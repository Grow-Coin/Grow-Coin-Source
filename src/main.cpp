...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if(nHeight <= 11050)
    {
        nSubsidy = 24 * COIN;
    }

    else if(nHeight <= 21050)
    {
        nSubsidy = 36 * COIN;
    }

    else if(nHeight <= 31050)
    {
        nSubsidy = 48 * COIN;
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "GrowCoin 19/11/2014";
        CTransaction txNew;
        txNew.nTime = 1416382769;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416382769;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1150532;
        uint256 hash = block.GetHash();
        printf("%s\n", hash.ToString().c_str());
        printf("%s\n", hashGenesisBlock.ToString().c_str());
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0xf06b1ae9372c2bf2f52abb85e091b3e2b56610fad25cd74ea22af89cb3da6cf4"));
